                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="">Code parrain<span class="text-danger"></span></label>

                            <div class="position-relative">
                                <i data-feather="edit-2" class="fea icon-sm icons"></i>
                                <input  class="pl-5 form-control" placeholder="{{ $user->affiliateLink }} || {{ $user->lastname }} {{ $user->firstname }}" readonly>
                            </div>
